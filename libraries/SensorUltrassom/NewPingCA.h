...
#define NO_ECHO 99999               // Value returned if there's no ping echo within the specified MAX_SENSOR_DISTANCE or max_cm_distance.
...
class NewPingCA {
	public:
		NewPingCA();
                void start(uint8_t trigger_pin, uint8_t echo_pin, int max_cm_distance = MAX_SENSOR_DISTANCE);
		unsigned int ping();
