...
MovingAverageFilter altitudePressaoF(100);
MovingAverageFilter velocidadeCalibradaF(40);
MovingAverageFilter taxaDeRolamentoF(25);
MovingAverageFilter taxaDeArfagemF(25);
MovingAverageFilter taxaDeGuinadaF(25);
MovingAverageFilter fatorDeCargaXF(15);
MovingAverageFilter fatorDeCargaYF(15);
MovingAverageFilter fatorDeCargaZF(15);
MovingAverageFilter posicaoXF(15);
MovingAverageFilter posicaoYF(15);
MovingAverageFilter posicaoZF(100);
MovingAverageFilter atitudeF(40);
MovingAverageFilter inclinacaoLateralF(40);
...
void loop() {
 ...
 //   nilThdSleep(80);
    ...
    sdhelp.escreveDadoSD(",");
    sdhelp.escreveDadoSD(velocidadeCalibradaF.process(gps.getVelocidade()));
    sdhelp.escreveDadoSD(",");
